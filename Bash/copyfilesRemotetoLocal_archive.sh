...
# for f in $Subdir; do sshpass -p 'xxxx' scp igelstachelbart@sprout.ggy.bris.ac.uk:cgenie_output/$f/biogem/{fields_biogem_2d.nc,fields_biogem_3d.nc\} ./$f/biogem/.; done
