...
# for f in $Subdir; do sshpass -p 'xxx' scp igelstachelbart@sprout.ggy.bris.ac.uk:cgenie_output/$f/biogem/{fields_biogem_2d.nc,fields_biogem_3d.nc,biogem_year_09999_500_diag_GLOBAL_AVERAGE.res,biogem_series_ocn_O2.res,biogem_series_ocn_H2S.res,biogem_series_fseaair_pH2S.res\} ./$f/biogem/.; done
