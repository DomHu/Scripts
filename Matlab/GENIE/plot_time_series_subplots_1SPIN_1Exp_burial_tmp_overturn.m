function [] = plot_time_series_subplots_1SPIN_1Exp_burial_tmp_overturn(PEXP_SPIN, PEXP1_OPEN, PNAME_SPIN, PNAME_OPEN1, FILENAME)
% plot time-series
%clear all;
...
if(true)
%% plot input to calculate OM burial
figure
grid on
hold on
...
%plot(REF(:,1),REF(:,3)*1e+6,'k')
%plot(REF_sed_pO2(:,1),REF_sed_pO2(:,3),'k',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r' );
plot(REF_fsedocn_DIC_exp1(:,1),REF_fsedocn_DIC_exp1(:,2)*12*1e-15,'k', ...
    REF_fsedocn_DIC_exp2(:,1)+years_SPIN,REF_fsedocn_DIC_exp2(:,2)*12*1e-15,'k--');
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'k',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1),REF_sed_pO2_exp3(:,3),'r--',REF_sed_pO2_exp4(:,1),REF_sed_pO2_exp4(:,3),'g--'); 
%xlabel('years ');
ylabel({'DIC return'; '(PgC yr^{-1})'});
% xlim([10000 220000])
% ylim([0.1 0.22])    % 1 x O2
% ylim([0.0 0.5])    % 0.5 x O2
% set(gca,'YtickLabel',{[]})
...
% benthic O2
subplot(3, 2, 5)
    plot(REF_fsedocn_Ca_exp1(:,1),REF_fsedocn_Ca_exp1(:,2)*12*1e-15,'k', ...
         REF_fsedocn_Ca_exp2(:,1)+years_SPIN,REF_fsedocn_Ca_exp2(:,2)*12*1e-15,'k--'); 
     ylabel({'Ca return'; '(Pg yr^{-1})'});
% xlim([10000 220000])
% ylim([0 110])
% set(gca,'Ytick',10:1:30)
% set(gca,'YtickLabel',{'10', '', '','','','15','','','','','20','','','','','25','','','','','30'})
...
if(plot_mean)  % mean (mol/kg)
    print('-depsc', ['PLOTS/timeseries/' FILENAME '_MEAN_POC_burial_ana']);
else
    print('-depsc', ['PLOTS/timeseries/' FILENAME '_POC_burial_ana']);
end
end
