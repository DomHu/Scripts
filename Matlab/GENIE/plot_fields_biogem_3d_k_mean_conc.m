function [Mean_H2S, STATM] = plot_fields_biogem_3d_k_mean_conc(PEXP1,PEXP2,PVAR1,PVAR2,PT1,PT2,PIK,PMASK,PCSCALE,PCMIN,PCMAX,PCN,PDATA,POPT,PNAME)
...
overlaydata_zm(:,:) = zm(:,:);
% DH: save vector of concentrations in .mat file
Vec_H2S = reshape(zm,1,[]);
filename; %= [PNAME, '.mat'];
filename2 = [exp_1(1:8), '_', dataid_1, '_', 'k', num2str(kplot)]
save([filename2, '.mat'],'Vec_H2S')
% calculate mean concetration and return to calling fct
Mean_H2S = nanmean(Vec_H2S)
