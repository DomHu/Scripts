function [] = plot_time_series_subplots_2SPINs_6Exp_burial_tmp_overturn(PEXP_SPIN, PEXP_SPIN2, PEXP_SPIN3, PEXP_SPIN4, PEXP1_OPEN, PEXP2_OPEN, PEXP3_OPEN, PEXP4_OPEN, PNAME_SPIN, PNAME_SPIN2, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, PNAME_OPEN4, PNAME_OPEN5, PNAME_OPEN6, FILENAME)
% plot time-series
%clear all;
...
exp_SPIN1 = ['./cgenie_output/' PEXP_SPIN];   
...
plot(REF_atm_tmp_exp1(:,1),REF_atm_tmp_exp1(:,2),'k', ...
    REF_atm_tmp_exp2(:,1),REF_atm_tmp_exp2(:,2),'c--',  ...
    REF_atm_tmp_exp3(:,1)+years_SPIN,REF_atm_tmp_exp3(:,2),'c:', ...
     REF_atm_tmp_exp4(:,1)+years_SPIN,REF_atm_tmp_exp4(:,2),'m:',  ...
    REF_atm_tmp_exp5(:,1)+years_SPIN,REF_atm_tmp_exp5(:,2),'k:', ...
     REF_atm_tmp_exp6(:,1)+years_SPIN,REF_atm_tmp_exp6(:,2),'b:', ...
     REF_atm_tmp_exp7(:,1)+years_SPIN,REF_atm_tmp_exp7(:,2),'g:', ...
     REF_atm_tmp_exp8(:,1)+years_SPIN,REF_atm_tmp_exp8(:,2),'r:'); 
%plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'k',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r',REF_sed_pCO2_exp3(:,1),REF_sed_pCO2_exp3(:,3)*1e+6,'g:',REF_sed_pCO2_exp4(:,1),REF_sed_pCO2_exp4(:,3)*1e+6,'m:'); 
%xlabel('years ');
...
plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'k', ...
    REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'c--',  ...
    REF_sed_pCO2_exp3(:,1)+years_SPIN,REF_sed_pCO2_exp3(:,3)*1e+6,'c:', ...
     REF_sed_pCO2_exp4(:,1)+years_SPIN,REF_sed_pCO2_exp4(:,3)*1e+6,'m:',  ...
    REF_sed_pCO2_exp5(:,1)+years_SPIN,REF_sed_pCO2_exp5(:,3)*1e+6,'k:', ...
     REF_sed_pCO2_exp6(:,1)+years_SPIN,REF_sed_pCO2_exp6(:,3)*1e+6,'b:', ...
     REF_sed_pCO2_exp7(:,1)+years_SPIN,REF_sed_pCO2_exp7(:,3)*1e+6,'g:', ...
...
plot(REF_misc_opsi_exp1(:,1),REF_misc_opsi_exp1(:,2),'k', ...
    REF_misc_opsi_exp2(:,1),REF_misc_opsi_exp2(:,2),'c--',  ...
    REF_misc_opsi_exp3(:,1)+years_SPIN,REF_misc_opsi_exp3(:,2),'c:', ...
    REF_misc_opsi_exp4(:,1)+years_SPIN,REF_misc_opsi_exp4(:,2),'m:',  ...
    REF_misc_opsi_exp5(:,1)+years_SPIN,REF_misc_opsi_exp5(:,2),'k:',  ...
    REF_misc_opsi_exp6(:,1)+years_SPIN,REF_misc_opsi_exp6(:,2),'b:',  ...
    REF_misc_opsi_exp7(:,1)+years_SPIN,REF_misc_opsi_exp7(:,2),'g:',  ...
...
plot(REF_misc_opsi_exp1(:,1),REF_misc_opsi_exp1(:,3),'k', ...
    REF_misc_opsi_exp2(:,1),REF_misc_opsi_exp2(:,3),'c--',  ...
    REF_misc_opsi_exp3(:,1)+years_SPIN,REF_misc_opsi_exp3(:,3),'c:', ...
    REF_misc_opsi_exp4(:,1)+years_SPIN,REF_misc_opsi_exp4(:,3),'m:',  ...
    REF_misc_opsi_exp5(:,1)+years_SPIN,REF_misc_opsi_exp5(:,3),'k:',  ...
    REF_misc_opsi_exp6(:,1)+years_SPIN,REF_misc_opsi_exp6(:,3),'b:',  ...
    REF_misc_opsi_exp7(:,1)+years_SPIN,REF_misc_opsi_exp7(:,3),'g:',  ...
...
plot(REF_fexport_POC_exp1(:,1),REF_fexport_POC_exp1(:,2),'k', ...
    REF_fexport_POC_exp2(:,1),REF_fexport_POC_exp2(:,2),'c--',  ...
    REF_fexport_POC_exp3(:,1)+years_SPIN,REF_fexport_POC_exp3(:,2),'c:',  ...
    REF_fexport_POC_exp4(:,1)+years_SPIN,REF_fexport_POC_exp4(:,2),'m:',  ...
    REF_fexport_POC_exp5(:,1)+years_SPIN,REF_fexport_POC_exp5(:,2),'k:',  ...
    REF_fexport_POC_exp6(:,1)+years_SPIN,REF_fexport_POC_exp6(:,2),'b:',  ...
    REF_fexport_POC_exp7(:,1)+years_SPIN,REF_fexport_POC_exp7(:,2),'g:',  ...
...
if(plot_mean) % mean (mol/kg)
    plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,3)*1e+6,'k', ...
         REF_sed_PO4_exp2(:,1),REF_sed_PO4_exp2(:,3)*1e+6,'c--',  ...
         REF_sed_PO4_exp3(:,1)+years_SPIN,REF_sed_PO4_exp3(:,3)*1e+6,'c:', ...
         REF_sed_PO4_exp4(:,1)+years_SPIN,REF_sed_PO4_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_PO4_exp5(:,1)+years_SPIN,REF_sed_PO4_exp5(:,3)*1e+6,'k:' ,  ...
         REF_sed_PO4_exp6(:,1)+years_SPIN,REF_sed_PO4_exp6(:,3)*1e+6,'b:' ,  ...
         REF_sed_PO4_exp7(:,1)+years_SPIN,REF_sed_PO4_exp7(:,3)*1e+6,'g:',  ...
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,2),'k',...
        REF_sed_PO4_exp2(:,1),REF_sed_PO4_exp2(:,2),'c--', ...
        REF_sed_PO4_exp3(:,1)+years_SPIN,REF_sed_PO4_exp3(:,2),'c:',...
        REF_sed_PO4_exp4(:,1)+years_SPIN,REF_sed_PO4_exp4(:,2),'m:', ...
        REF_sed_PO4_exp5(:,1)+years_SPIN,REF_sed_PO4_exp5(:,2),'k:', ...
     	REF_sed_PO4_exp6(:,1)+years_SPIN,REF_sed_PO4_exp6(:,2),'b:', ...
     	REF_sed_PO4_exp7(:,1)+years_SPIN,REF_sed_PO4_exp7(:,2),'g:', ...
...
subplot(3, 2, 1)
    plot(REF_focnsed_POC_exp1(:,1),REF_focnsed_POC_exp1(:,2)*12*1e-15,'k', ...
         REF_focnsed_POC_exp2(:,1),REF_focnsed_POC_exp2(:,2)*12*1e-15,'c--', ...
         REF_focnsed_POC_exp3(:,1)+years_SPIN,REF_focnsed_POC_exp3(:,2)*12*1e-15,'c:', ...
         REF_focnsed_POC_exp4(:,1)+years_SPIN,REF_focnsed_POC_exp4(:,2)*12*1e-15,'m:', ...
         REF_focnsed_POC_exp5(:,1)+years_SPIN,REF_focnsed_POC_exp5(:,2)*12*1e-15,'k:', ...
         REF_focnsed_POC_exp6(:,1)+years_SPIN,REF_focnsed_POC_exp6(:,2)*12*1e-15,'b:', ...
         REF_focnsed_POC_exp7(:,1)+years_SPIN,REF_focnsed_POC_exp7(:,2)*12*1e-15,'g:', ...
...
plot(REF_sed_DIC_13C_exp1(:,1),REF_sed_DIC_13C_exp1(:,3),'k',  ...
    REF_sed_DIC_13C_exp2(:,1),REF_sed_DIC_13C_exp2(:,3),'c--',  ...
    REF_sed_DIC_13C_exp3(:,1)+years_SPIN,REF_sed_DIC_13C_exp3(:,3),'c:',  ...
    REF_sed_DIC_13C_exp4(:,1)+years_SPIN,REF_sed_DIC_13C_exp4(:,3),'m:',  ...
    REF_sed_DIC_13C_exp5(:,1)+years_SPIN,REF_sed_DIC_13C_exp5(:,3),'k:',  ...
    REF_sed_DIC_13C_exp6(:,1)+years_SPIN,REF_sed_DIC_13C_exp6(:,3),'b:',  ...
    REF_sed_DIC_13C_exp7(:,1)+years_SPIN,REF_sed_DIC_13C_exp7(:,3),'g:',  ...
...
plot(REF_POC_burial_exp1(:,1),REF_POC_burial_exp1(:,2),'k', ...
    REF_POC_burial_exp2(:,1),REF_POC_burial_exp2(:,2),'c--', ...
    REF_POC_burial_exp3(:,1)+years_SPIN,REF_POC_burial_exp3(:,2),'c:', ...
    REF_POC_burial_exp4(:,1)+years_SPIN,REF_POC_burial_exp4(:,2),'m:', ...
    REF_POC_burial_exp5(:,1)+years_SPIN,REF_POC_burial_exp5(:,2),'k:', ...
    REF_POC_burial_exp6(:,1)+years_SPIN,REF_POC_burial_exp6(:,2),'b:', ...
    REF_POC_burial_exp7(:,1)+years_SPIN,REF_POC_burial_exp7(:,2),'g:', ...
    REF_POC_burial_exp8(:,1)+years_SPIN,REF_POC_burial_exp8(:,2),'r:');
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'k',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1),REF_sed_pO2_exp3(:,3),'g:',REF_sed_pO2_exp4(:,1),REF_sed_pO2_exp4(:,3),'m:'); 
%xlabel('years ');
...
subplot(3, 2, 4)
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,5)*1e+6,'k', ...
         REF_sed_O2_exp2(:,1),REF_sed_O2_exp2(:,5)*1e+6,'c--', ...
         REF_sed_O2_exp3(:,1)+years_SPIN,REF_sed_O2_exp3(:,5)*1e+6,'c:', ...
         REF_sed_O2_exp4(:,1)+years_SPIN,REF_sed_O2_exp4(:,5)*1e+6,'m:',  ...
         REF_sed_O2_exp5(:,1)+years_SPIN,REF_sed_O2_exp5(:,5)*1e+6,'k:',  ...
         REF_sed_O2_exp6(:,1)+years_SPIN,REF_sed_O2_exp6(:,5)*1e+6,'b:',  ...
         REF_sed_O2_exp7(:,1)+years_SPIN,REF_sed_O2_exp7(:,5)*1e+6,'g:',  ...
...
plot(REF_POC_burial_exp1(:,1),REF_POC_burial_exp1(:,2),'k', ...
    ...
    REF_POC_burial_exp7(:,1)+years_SPIN,REF_POC_burial_exp7(:,2),'g:', ...
    REF_POC_burial_exp8(:,1)+years_SPIN,REF_POC_burial_exp8(:,2),'r:');
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'b--',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1)+years_SPIN,REF_sed_pO2_exp3(:,3),'g:',REF_sed_pO2_exp4(:,1)+years_SPIN,REF_sed_pO2_exp4(:,3),'r:'); 
%xlabel('years ');
...
%plot(REF(:,1),REF(:,3)*1e+6,'b--')
%plot(REF_sed_pO2(:,1),REF_sed_pO2(:,3),'b--',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r' );
plot(REF_sed_CaCO3_exp1(:,1),REF_sed_CaCO3_exp1(:,2),'k', ...
    REF_sed_CaCO3_exp2(:,1),REF_sed_CaCO3_exp2(:,2),'c--', ...
    REF_sed_CaCO3_exp3(:,1)+years_SPIN,REF_sed_CaCO3_exp3(:,2),'c:', ...
    REF_sed_CaCO3_exp4(:,1)+years_SPIN,REF_sed_CaCO3_exp4(:,2),'m:', ...
    REF_sed_CaCO3_exp5(:,1)+years_SPIN,REF_sed_CaCO3_exp5(:,2),'k:', ...
    REF_sed_CaCO3_exp6(:,1)+years_SPIN,REF_sed_CaCO3_exp6(:,2),'b:', ...
    REF_sed_CaCO3_exp7(:,1)+years_SPIN,REF_sed_CaCO3_exp7(:,2),'g:', ...
...
if(plot_mean) % mean (mol/kg)
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,3)*1e+6,'k', ...
         REF_sed_O2_exp2(:,1),REF_sed_O2_exp2(:,3)*1e+6,'c--', ...
         REF_sed_O2_exp3(:,1)+years_SPIN,REF_sed_O2_exp3(:,3)*1e+6,'c:', ...
         REF_sed_O2_exp4(:,1)+years_SPIN,REF_sed_O2_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_O2_exp5(:,1)+years_SPIN,REF_sed_O2_exp5(:,3)*1e+6,'k:',  ...
         REF_sed_O2_exp6(:,1)+years_SPIN,REF_sed_O2_exp6(:,3)*1e+6,'b:',  ...
         REF_sed_O2_exp7(:,1)+years_SPIN,REF_sed_O2_exp7(:,3)*1e+6,'g:',  ...
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,2),'k', ...
         REF_sed_O2_exp2(:,1),REF_sed_O2_exp2(:,2),'c--', ...
         REF_sed_O2_exp3(:,1)+years_SPIN,REF_sed_O2_exp3(:,2),'c:', ...
         REF_sed_O2_exp4(:,1)+years_SPIN,REF_sed_O2_exp4(:,2),'m:', ...
         REF_sed_O2_exp5(:,1)+years_SPIN,REF_sed_O2_exp5(:,2),'k:', ...
         REF_sed_O2_exp6(:,1)+years_SPIN,REF_sed_O2_exp6(:,2),'b:', ...
         REF_sed_O2_exp7(:,1)+years_SPIN,REF_sed_O2_exp7(:,2),'g:', ...
...
if(plot_mean)  % mean (mol/kg)
	plot(REF_sed_SO4_exp1(:,1),REF_sed_SO4_exp1(:,3)*1e+6,'k', ...
         REF_sed_SO4_exp2(:,1),REF_sed_SO4_exp2(:,3)*1e+6,'c--', ...
         REF_sed_SO4_exp3(:,1)+years_SPIN,REF_sed_SO4_exp3(:,3)*1e+6,'c:', ...
         REF_sed_SO4_exp4(:,1)+years_SPIN,REF_sed_SO4_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_SO4_exp5(:,1)+years_SPIN,REF_sed_SO4_exp5(:,3)*1e+6,'k:',  ...
         REF_sed_SO4_exp6(:,1)+years_SPIN,REF_sed_SO4_exp6(:,3)*1e+6,'b:' ,  ...
         REF_sed_SO4_exp7(:,1)+years_SPIN,REF_sed_SO4_exp7(:,3)*1e+6,'g:',  ...
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_SO4_exp1(:,1),REF_sed_SO4_exp1(:,2),'k',...
        REF_sed_SO4_exp2(:,1),REF_sed_SO4_exp2(:,2),'c--',...
        REF_sed_SO4_exp3(:,1)+years_SPIN,REF_sed_SO4_exp3(:,2),'c:',...
        REF_sed_SO4_exp4(:,1)+years_SPIN,REF_sed_SO4_exp4(:,2),'m:', ...
        REF_sed_SO4_exp5(:,1)+years_SPIN,REF_sed_SO4_exp5(:,2),'k:',...
     	REF_sed_SO4_exp6(:,1)+years_SPIN,REF_sed_SO4_exp6(:,2),'b:',...
     	REF_sed_SO4_exp7(:,1)+years_SPIN,REF_sed_SO4_exp7(:,2),'g:',...
...
if(plot_mean) % mean (mol/kg)
	plot(REF_sed_H2S_exp1(:,1),REF_sed_H2S_exp1(:,3)*1e+6,'k', ...
         REF_sed_H2S_exp2(:,1),REF_sed_H2S_exp2(:,3)*1e+6,'c--',  ...
         REF_sed_H2S_exp3(:,1)+years_SPIN,REF_sed_H2S_exp3(:,3)*1e+6,'c:', ...
         REF_sed_H2S_exp4(:,1)+years_SPIN,REF_sed_H2S_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_H2S_exp5(:,1)+years_SPIN,REF_sed_H2S_exp5(:,3)*1e+6,'k:',  ...
         REF_sed_H2S_exp6(:,1)+years_SPIN,REF_sed_H2S_exp6(:,3)*1e+6,'b:',  ...
         REF_sed_H2S_exp7(:,1)+years_SPIN,REF_sed_H2S_exp7(:,3)*1e+6,'g:',  ...
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_H2S_exp1(:,1),REF_sed_H2S_exp1(:,2),'k',...
        REF_sed_H2S_exp2(:,1),REF_sed_H2S_exp2(:,2),'c--', ...
        REF_sed_H2S_exp3(:,1)+years_SPIN,REF_sed_H2S_exp3(:,2),'c:', ...
        REF_sed_H2S_exp4(:,1)+years_SPIN,REF_sed_H2S_exp4(:,2),'m:', ...
        REF_sed_H2S_exp5(:,1)+years_SPIN,REF_sed_H2S_exp5(:,2),'k:', ...
     	REF_sed_H2S_exp6(:,1)+years_SPIN,REF_sed_H2S_exp6(:,2),'b:', ...
     	REF_sed_H2S_exp7(:,1)+years_SPIN,REF_sed_H2S_exp7(:,2),'g:', ...
...
% if(plot_mean) % mean (mol/kg)
%     plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,3)*1e+6,'k', ...
%          REF_sed_PO4_exp2(:,1),REF_sed_PO4_exp2(:,3)*1e+6,'k',  ...
...
% else % total (mol)
%     plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,2),'k',...
%         REF_sed_PO4_exp2(:,1),REF_sed_PO4_exp2(:,2),'k', ...
...
if(plot_mean)  % mean (mol/kg)
    plot(REF_sed_ALK_exp1(:,1),REF_sed_ALK_exp1(:,3)*1e+6,'k', ...
         REF_sed_ALK_exp2(:,1),REF_sed_ALK_exp2(:,3)*1e+6,'c--',  ...
         REF_sed_ALK_exp3(:,1)+years_SPIN,REF_sed_ALK_exp3(:,3)*1e+6,'c:', ...
         REF_sed_ALK_exp4(:,1)+years_SPIN,REF_sed_ALK_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_ALK_exp5(:,1)+years_SPIN,REF_sed_ALK_exp5(:,3)*1e+6,'k:',  ...
         REF_sed_ALK_exp6(:,1)+years_SPIN,REF_sed_ALK_exp6(:,3)*1e+6,'b:',  ...
         REF_sed_ALK_exp7(:,1)+years_SPIN,REF_sed_ALK_exp7(:,3)*1e+6,'g:',  ...
         REF_sed_ALK_exp8(:,1)+years_SPIN,REF_sed_ALK_exp8(:,3)*1e+6,'r:'); 
         ylabel({'ALK'; '(\mumol kg^{-1})'});
%       ylabel('(\mumol kg^{-1})');
else
	plot(REF_sed_ALK_exp1(:,1),REF_sed_ALK_exp1(:,2),'k',...
        REF_sed_ALK_exp2(:,1),REF_sed_ALK_exp2(:,2),'c--',...
        REF_sed_ALK_exp3(:,1)+years_SPIN,REF_sed_ALK_exp3(:,2),'c:',...
        REF_sed_ALK_exp4(:,1)+years_SPIN,REF_sed_ALK_exp4(:,2),'m:', ...
        REF_sed_ALK_exp5(:,1)+years_SPIN,REF_sed_ALK_exp5(:,2),'k:',...
        REF_sed_ALK_exp6(:,1)+years_SPIN,REF_sed_ALK_exp6(:,2),'b:',...
        REF_sed_ALK_exp7(:,1)+years_SPIN,REF_sed_ALK_exp7(:,2),'g:',...
...
if(plot_mean)  % mean (mol/kg)
    plot(REF_sed_DIC_exp1(:,1),REF_sed_DIC_exp1(:,3)*1e+6,'k', ...
         REF_sed_DIC_exp2(:,1),REF_sed_DIC_exp2(:,3)*1e+6,'c--',  ...
         REF_sed_DIC_exp3(:,1)+years_SPIN,REF_sed_DIC_exp3(:,3)*1e+6,'c:', ...
         REF_sed_DIC_exp4(:,1)+years_SPIN,REF_sed_DIC_exp4(:,3)*1e+6,'m:',  ...
         REF_sed_DIC_exp5(:,1)+years_SPIN,REF_sed_DIC_exp5(:,3)*1e+6,'k:',  ...
         REF_sed_DIC_exp6(:,1)+years_SPIN,REF_sed_DIC_exp6(:,3)*1e+6,'b:',  ...
         REF_sed_DIC_exp7(:,1)+years_SPIN,REF_sed_DIC_exp7(:,3)*1e+6,'g:',  ...
         REF_sed_DIC_exp8(:,1)+years_SPIN,REF_sed_DIC_exp8(:,3)*1e+6,'r:'); 
         ylabel({'DIC'; '(\mumol kg^{-1})'});
%        ylabel('(\mumol kg^{-1})');
else
	plot(REF_sed_DIC_exp1(:,1),REF_sed_DIC_exp1(:,2),'k',...
        REF_sed_DIC_exp2(:,1),REF_sed_DIC_exp2(:,2),'c--', ...
        REF_sed_DIC_exp3(:,1)+years_SPIN,REF_sed_DIC_exp3(:,2),'c:',...
        REF_sed_DIC_exp4(:,1)+years_SPIN,REF_sed_DIC_exp4(:,2),'m:',...
        REF_sed_DIC_exp5(:,1)+years_SPIN,REF_sed_DIC_exp5(:,2),'k:',...
        REF_sed_DIC_exp6(:,1)+years_SPIN,REF_sed_DIC_exp6(:,2),'b:',...
        REF_sed_DIC_exp6(:,1)+years_SPIN,REF_sed_DIC_exp6(:,2),'g:',...
