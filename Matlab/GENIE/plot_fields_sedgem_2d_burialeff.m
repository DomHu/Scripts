...
% % Dom: OMEN_wtpct_top
% dataid_wtpct_top = 'OMEN_wtpct_top';
% varid3 = [];
% while isempty(varid3)
%     for n = 0:nvars-1,
%         [varname,xtype,dimids,natts] = netcdf.inqVar(ncid_1,n);
%         if strcmp(varname,dataid_wtpct_top)
%             varid3 = n;
%         end
%     end
%     if isempty(varid3)
...
rawdata = netcdf.getVar(ncid_1,varid);
% Dom
%[varname_wtpct_top,xtype_wtpct_top,dimids,natts_wtpct_top] = netcdf.inqVar(ncid_1,varid3);
%rawdata = netcdf.getVar(ncid_1,varid3)/netcdf.getVar(ncid_1,varid)*100;
