function[]=Dom_plot_Profiles_Atlantic()
...
% load H2S data
No_Sulf_H2S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2509_08_p0093k.2P4pCO2_With_OMEN_No_sulf_k2_1e-5_anoxic.y9999.5.ocn_H2S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
SulfE5_H2S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_04_p0093k.2P4pCO2_With_OMEN_withSulf_10E+5_sulf_k2_1e-5_anoxic.y9999.5.ocn_H2S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
SulfE6_H2S =  load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_05_p0093k.2P4pCO2_With_OMEN_withSulf_10E+6_sulf_k2_1e-5_anoxic.y9999.5.ocn_H2S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
SulfE7_H2S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_06_p0093k.2P4pCO2_With_OMEN_withSulf_O2ana_sulf_k2_1e-5_anoxic.y9999.5.ocn_H2S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));

% load POC data
No_Sulf_POC = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2509_08_p0093k.2P4pCO2_With_OMEN_No_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POC.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E5_POC = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_04_p0093k.2P4pCO2_With_OMEN_withSulf_10E+5_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POC.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E6_POC =  load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_05_p0093k.2P4pCO2_With_OMEN_withSulf_10E+6_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POC.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E7_POC = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_06_p0093k.2P4pCO2_With_OMEN_withSulf_O2ana_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POC.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));

% load POM_S data
No_Sulf_POM_S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2509_08_p0093k.2P4pCO2_With_OMEN_No_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POM_S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E5_POM_S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_04_p0093k.2P4pCO2_With_OMEN_withSulf_10E+5_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POM_S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E6_POM_S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_05_p0093k.2P4pCO2_With_OMEN_withSulf_10E+6_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POM_S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
Sulf_E7_POM_S = load(fullfile('.', 'cgenie_output','0_PLOTS','2509_plots','PROFILES','BASINS','Atl', '2909_06_p0093k.2P4pCO2_With_OMEN_withSulf_O2ana_sulf_k2_1e-5_anoxic.y9999.5.bio_fpart_POM_S.mask_OAE2_Atl_1910.csv.PROFILE.171021.res'));
...
print('-depsc', '0_Impact_Profiles_H2S_Atl');
...
print('-depsc', '0_Sulf_Impact_Profiles_POC_Atl');
...
print('-depsc', '0_Sulf_Impact_Profiles_POM_S_Atl');
...
print('-depsc', '0_Sulf_Impact_Profiles_FRAC_POM_S_Atl');
...
% ylabel('Depth (km)');
% 
% print('-depsc', '0_Impact_Profiles_O2_PEAK_Atl_new');
% 
% 
% figure
...
% ylabel('Depth (km)');
% 
% print('-depsc', '0_Impact_Profiles_H2S_PEAK_Atl_new');
% 
% figure
...
% ylabel('Depth (km)');
% 
% print('-depsc', '0_Impact_Profiles_PO4_PEAK_Atl');
