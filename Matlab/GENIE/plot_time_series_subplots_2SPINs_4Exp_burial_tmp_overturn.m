function [] = plot_time_series_subplots_2SPINs_4Exp_burial_tmp_overturn(PEXP_SPIN1, PEXP_SPIN2, PEXP_SPIN3, PEXP_SPIN4, PEXP1_OPEN, PEXP2_OPEN, PNAME_SPIN1, PNAME_SPIN2, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, PNAME_OPEN4,FILENAME)
% plot time-series
%clear all;
...
plot(REF_atm_tmp_exp1(:,1),REF_atm_tmp_exp1(:,2),'b--', ...
    ...
    REF_atm_tmp_exp5(:,1)+years_SPIN+years_SPIN2,REF_atm_tmp_exp5(:,2),'g--', ...
     REF_atm_tmp_exp6(:,1)+years_SPIN+years_SPIN2,REF_atm_tmp_exp6(:,2),'g:'); 
%xlabel('years ');
...
plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'b--', ...
    ...
    REF_sed_pCO2_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_pCO2_exp5(:,3)*1e+6,'g--', ...
     REF_sed_pCO2_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_pCO2_exp6(:,3)*1e+6,'g:'); 
%plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'b--',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r',REF_sed_pCO2_exp3(:,1)+years_SPIN,REF_sed_pCO2_exp3(:,3)*1e+6,'r--',REF_sed_pCO2_exp4(:,1)+years_SPIN,REF_sed_pCO2_exp4(:,3)*1e+6,'r:'); 
%xlabel('years ');
ylabel({'pCO2'; '(ppm)'});
% xlim([10000 120000])
% ylim([0 2000])
...
plot(REF_misc_opsi_exp1(:,1),REF_misc_opsi_exp1(:,2),'b--', ...
    ...
    REF_misc_opsi_exp5(:,1)+years_SPIN+years_SPIN2,REF_misc_opsi_exp5(:,2),'g--',  ...
    REF_misc_opsi_exp6(:,1)+years_SPIN+years_SPIN2,REF_misc_opsi_exp6(:,2),'g:'); 
%plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'b--',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r',REF_sed_pCO2_exp3(:,1)+years_SPIN,REF_sed_pCO2_exp3(:,3)*1e+6,'r--',REF_sed_pCO2_exp4(:,1)+years_SPIN,REF_sed_pCO2_exp4(:,3)*1e+6,'r:'); 
%xlabel('years ');
...
plot(REF_misc_opsi_exp1(:,1),REF_misc_opsi_exp1(:,3),'b--', ...
    ...
    REF_misc_opsi_exp5(:,1)+years_SPIN+years_SPIN2,REF_misc_opsi_exp5(:,3),'g--',  ...
    REF_misc_opsi_exp6(:,1)+years_SPIN+years_SPIN2,REF_misc_opsi_exp6(:,3),'g:'); 
%xlabel('years ');
...
plot(REF_fexport_POC_exp1(:,1),REF_fexport_POC_exp1(:,2),'b--', ...
    ...
    REF_fexport_POC_exp5(:,1)+years_SPIN+years_SPIN2,REF_fexport_POC_exp5(:,2),'g--',  ...
    REF_fexport_POC_exp6(:,1)+years_SPIN+years_SPIN2,REF_fexport_POC_exp6(:,2),'g:'); 
%plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'b--',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r',REF_sed_pCO2_exp3(:,1)+years_SPIN,REF_sed_pCO2_exp3(:,3)*1e+6,'r--',REF_sed_pCO2_exp4(:,1)+years_SPIN,REF_sed_pCO2_exp4(:,3)*1e+6,'r:'); 
%xlabel('years ');
...
if(plot_mean) % mean (mol/kg)
    plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_PO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp5(:,3)*1e+6,'g--' ,  ...
         REF_sed_PO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp6(:,3)*1e+6,'g:'); 
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,2),'b--',...
        ...
        REF_sed_PO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp5(:,2),'g--', ...
     	REF_sed_PO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp6(:,2),'g:')
    ylabel('PO_4 (mol)');
end
% set(gca,'xticklabel',{[]})
% xlim([10000 120000])
...
subplot(3, 2, 1)
    plot(REF_focnsed_POC_exp1(:,1),REF_focnsed_POC_exp1(:,2)*12*1e-15,'b--', ...
         ...
         REF_focnsed_POC_exp5(:,1)+years_SPIN+years_SPIN2,REF_focnsed_POC_exp5(:,2)*12*1e-15,'g--', ...
         REF_focnsed_POC_exp6(:,1)+years_SPIN+years_SPIN2,REF_focnsed_POC_exp6(:,2)*12*1e-15,'g:'); 
...
plot(REF_sed_DIC_13C_exp1(:,1),REF_sed_DIC_13C_exp1(:,3),'b--',  ...
    ...
    REF_sed_DIC_13C_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_13C_exp5(:,3),'g--',  ...
    REF_sed_DIC_13C_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_13C_exp6(:,3),'g:'); 
%xlabel('years ');
...
plot(REF_POC_burial_exp1(:,1),REF_POC_burial_exp1(:,2),'b--', ...
    ...
    REF_POC_burial_exp5(:,1)+years_SPIN+years_SPIN2,REF_POC_burial_exp5(:,2),'g--', ...
    REF_POC_burial_exp6(:,1)+years_SPIN+years_SPIN2,REF_POC_burial_exp6(:,2),'g:');
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'b--',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1)+years_SPIN,REF_sed_pO2_exp3(:,3),'r--',REF_sed_pO2_exp4(:,1)+years_SPIN,REF_sed_pO2_exp4(:,3),'r:'); 
%xlabel('years ');
...
subplot(3, 2, 4)
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,5)*1e+6,'b--', ...
         ...
         REF_sed_O2_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp5(:,5)*1e+6,'g--',  ...
         REF_sed_O2_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp6(:,5)*1e+6,'g:'); 
...
plot(REF_sed_CaCO3_exp1(:,1),REF_sed_CaCO3_exp1(:,2),'b--', ...
    ...
    REF_sed_CaCO3_exp3(:,1)+years_SPIN,REF_sed_CaCO3_exp3(:,2),'r--', ...
    REF_sed_CaCO3_exp4(:,1)+years_SPIN,REF_sed_CaCO3_exp4(:,2),'r:', ...
    REF_sed_CaCO3_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_CaCO3_exp5(:,2),'g--', ...
    REF_sed_CaCO3_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_CaCO3_exp6(:,2),'g:');
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'b--',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1)+years_SPIN,REF_sed_pO2_exp3(:,3),'r--',REF_sed_pO2_exp4(:,1)+years_SPIN,REF_sed_pO2_exp4(:,3),'r:'); 
%xlabel('years ');
ylabel({'CaCO_3'; '(wt%)'});
% xlim([10000 120000])
...
if(plot_mean) % mean (mol/kg)
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_O2_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp5(:,3)*1e+6,'g--',  ...
         REF_sed_O2_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp6(:,3)*1e+6,'g:'); 
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_O2_exp1(:,1),REF_sed_O2_exp1(:,2),'b--', ...
         ...
         REF_sed_O2_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp5(:,2),'b--', ...
         REF_sed_O2_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_O2_exp6(:,2),'b:')
     ylabel('O_2 (mol)');
end
% set(gca,'xticklabel',{[]})
% xlim([10000 120000])
...
if(plot_mean)  % mean (mol/kg)
	plot(REF_sed_SO4_exp1(:,1),REF_sed_SO4_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_SO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_SO4_exp5(:,3)*1e+6,'g--',  ...
         REF_sed_SO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_SO4_exp6(:,3)*1e+6,'g:'); 
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_SO4_exp1(:,1),REF_sed_SO4_exp1(:,2),'b--',...
        ...
        REF_sed_SO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_SO4_exp5(:,2),'b--',...
     	REF_sed_SO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_SO4_exp6(:,2),'b:')
    ylabel('SO_4 (mol)');
end
% set(gca,'xticklabel',{[]})
% xlim([10000 120000])
...
if(plot_mean) % mean (mol/kg)
	plot(REF_sed_H2S_exp1(:,1),REF_sed_H2S_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_H2S_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_H2S_exp5(:,3)*1e+6,'g--',  ...
         REF_sed_H2S_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_H2S_exp6(:,3)*1e+6,'g:');
...
%        ylabel('(\mumol kg^{-1})');
    ...
    plot(REF_sed_H2S_exp1(:,1),REF_sed_H2S_exp1(:,2),'b--',...
        ...
        REF_sed_H2S_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_H2S_exp5(:,2),'b--', ...
     	REF_sed_H2S_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_H2S_exp6(:,2),'b:')
    ylabel('H_2S (mol)');
end
% set(gca,'xticklabel',{[]})
% xlim([10000 120000])
...
% if(plot_mean) % mean (mol/kg)
%     plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,3)*1e+6,'b--', ...
%          REF_sed_PO4_exp2(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp2(:,3)*1e+6,'b--',  ...
%          REF_sed_PO4_exp3(:,1)+years_SPIN+years_SPIN+years_SPIN2,REF_sed_PO4_exp3(:,3)*1e+6,'r--', ...
%          REF_sed_PO4_exp4(:,1)+years_SPIN+years_SPIN+years_SPIN2,REF_sed_PO4_exp4(:,3)*1e+6,'r:',  ...
%          REF_sed_PO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp5(:,3)*1e+6,'g--' ,  ...
%          REF_sed_PO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp6(:,3)*1e+6,'g:'); 
%          ylabel({'PO_4'; '(\mumol kg^{-1})'});
% %        ylabel('(\mumol kg^{-1})');
% else % total (mol)
%     plot(REF_sed_PO4_exp1(:,1),REF_sed_PO4_exp1(:,2),'b--',...
%         REF_sed_PO4_exp2(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp2(:,2),'b--', ...
%         REF_sed_PO4_exp3(:,1)+years_SPIN+years_SPIN+years_SPIN2,REF_sed_PO4_exp3(:,2),'r--',...
%         REF_sed_PO4_exp4(:,1)+years_SPIN+years_SPIN+years_SPIN2,REF_sed_PO4_exp4(:,2),'r:', ...
%         REF_sed_PO4_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp5(:,2),'b--', ...
%      	REF_sed_PO4_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_PO4_exp6(:,2),'b:')
%     ylabel('PO_4 (mol)');
% end
% % set(gca,'xticklabel',{[]})
% % xlim([10000 120000])
...
if(plot_mean)  % mean (mol/kg)
    plot(REF_sed_ALK_exp1(:,1),REF_sed_ALK_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_ALK_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_ALK_exp5(:,3)*1e+6,'g--',  ...
         REF_sed_ALK_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_ALK_exp6(:,3)*1e+6,'g:'); 
...
%       ylabel('(\mumol kg^{-1})');
	...
	plot(REF_sed_ALK_exp1(:,1),REF_sed_ALK_exp1(:,2),'b--',...
        ...
        REF_sed_ALK_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_ALK_exp5(:,2),'b--',...
        REF_sed_ALK_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_ALK_exp6(:,2),'b:')
     ylabel('ALK (mol)');
end
...
if(plot_mean)  % mean (mol/kg)
    plot(REF_sed_DIC_exp1(:,1),REF_sed_DIC_exp1(:,3)*1e+6,'b--', ...
         ...
         REF_sed_DIC_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_exp5(:,3)*1e+6,'g--',  ...
         REF_sed_DIC_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_exp6(:,3)*1e+6,'g:'); 
...
%        ylabel('(\mumol kg^{-1})');
	...
	plot(REF_sed_DIC_exp1(:,1),REF_sed_DIC_exp1(:,2),'b--',...
        ...
        REF_sed_DIC_exp5(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_exp5(:,2),'b--',...
        REF_sed_DIC_exp6(:,1)+years_SPIN+years_SPIN2,REF_sed_DIC_exp6(:,2),'b:')
    ylabel('DIC (mol)');
end
% xlabel('Time since end of spin-up (ka)');
xlabel('Time');
