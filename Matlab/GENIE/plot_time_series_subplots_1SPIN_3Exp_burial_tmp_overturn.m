function [] = plot_time_series_subplots_1SPIN_3Exp_burial_tmp_overturn(PEXP_SPIN, PEXP1_OPEN, PEXP2_OPEN, PEXP3_OPEN, PNAME_SPIN, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, FILENAME)
% plot time-series
%clear all;
