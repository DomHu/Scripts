function [] = plot_time_series_subplots_4SPINs_burial_tmp_overturn(PEXP1_OPEN, PEXP2_OPEN, PEXP3_OPEN, PEXP4_OPEN, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, PNAME_OPEN4, FILENAME)
% plot time-series
%clear all;
