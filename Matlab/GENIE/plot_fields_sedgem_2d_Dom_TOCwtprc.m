function [STATM] = plot_fields_sedgem_2d_Dom_TOCwtprc(PEXP1,PEXP2,PVAR1,PVAR2,PT1,PT2,PIK,PMASK,PCSCALE,PCMIN,PCMAX,PCN,PDATA,POPT,PNAME)
...
if (~isempty(overlaydataid) && (data_only == 'n'))
    fid = fopen([filename '_MODELPOINTS' '.dat'], 'wt');
