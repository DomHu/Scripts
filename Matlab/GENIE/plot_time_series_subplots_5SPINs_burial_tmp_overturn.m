function [] = plot_time_series_subplots_5SPINs_burial_tmp_overturn(PEXP1_OPEN, PEXP2_OPEN, PEXP3_OPEN, PEXP4_OPEN, PEXP5_OPEN, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, PNAME_OPEN4, PNAME_OPEN5, FILENAME)
% plot time-series
%clear all;
...
subplot(3,2, 4)
plot(REF_misc_opsi_exp2(:,1)+years_SPIN,REF_misc_opsi_exp2(:,3),'k--',  ...
...
subplot(3, 2, 5)
%plot(REF_sed_pCO2(:,1),REF_sed_pCO2(:,3)*1e+6,'k',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r' ); 
plot(REF_fexport_POC_exp2(:,1)+years_SPIN,REF_fexport_POC_exp2(:,2),'k--',  ...
