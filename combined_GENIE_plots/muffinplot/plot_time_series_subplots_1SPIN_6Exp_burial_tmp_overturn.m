function [] = plot_time_series_subplots_1SPIN_6Exp_burial_tmp_overturn(PEXP_SPIN, PEXP1_OPEN, PEXP2_OPEN, PEXP3_OPEN, PEXP4_OPEN, PEXP5_OPEN, PEXP6_OPEN, PNAME_SPIN, PNAME_OPEN1, PNAME_OPEN2, PNAME_OPEN3, PNAME_OPEN4, PNAME_OPEN5, PNAME_OPEN6, FILENAME)
% plot time-series
%clear all;
...
plot(REF_misc_opsi_exp1(:,1),REF_misc_opsi_exp1(:,3),'k', ...
    REF_misc_opsi_exp2(:,1)+years_SPIN,REF_misc_opsi_exp2(:,3),'k--',  ...
    REF_misc_opsi_exp3(:,1)+years_SPIN,REF_misc_opsi_exp3(:,3),'r--', ...
    REF_misc_opsi_exp4(:,1)+years_SPIN,REF_misc_opsi_exp4(:,3),'g--',  ...
    REF_misc_opsi_exp5(:,1)+years_SPIN,REF_misc_opsi_exp5(:,3),'b:',  ...
    REF_misc_opsi_exp6(:,1)+years_SPIN,REF_misc_opsi_exp6(:,3),'m:',  ...
    REF_misc_opsi_exp7(:,1)+years_SPIN,REF_misc_opsi_exp7(:,3),'c:'); 
%xlabel('years ');
...
if(plot_mean)  % mean (mol/kg)
    print(fig1, '-depsc', ['PLOTS/' FILENAME '_MEAN_1']);
else
    print(fig1, '-depsc', ['PLOTS/' FILENAME '_1']);
end
...
plot(REF_fexport_POC_exp1(:,1),REF_fexport_POC_exp1(:,2),'k', ...
    REF_fexport_POC_exp2(:,1)+years_SPIN,REF_fexport_POC_exp2(:,2),'k--',  ...
    REF_fexport_POC_exp3(:,1)+years_SPIN,REF_fexport_POC_exp3(:,2),'r--',  ...
    REF_fexport_POC_exp4(:,1)+years_SPIN,REF_fexport_POC_exp4(:,2),'g--',  ...
    REF_fexport_POC_exp5(:,1)+years_SPIN,REF_fexport_POC_exp5(:,2),'b:',  ...
    REF_fexport_POC_exp6(:,1)+years_SPIN,REF_fexport_POC_exp6(:,2),'m:',  ...
    REF_fexport_POC_exp7(:,1)+years_SPIN,REF_fexport_POC_exp7(:,2),'c:'); 
%plot(REF_sed_pCO2_exp1(:,1),REF_sed_pCO2_exp1(:,3)*1e+6,'k',REF_sed_pCO2_exp2(:,1),REF_sed_pCO2_exp2(:,3)*1e+6,'r',REF_sed_pCO2_exp3(:,1),REF_sed_pCO2_exp3(:,3)*1e+6,'r--',REF_sed_pCO2_exp4(:,1),REF_sed_pCO2_exp4(:,3)*1e+6,'g--'); 
%xlabel('years ');
...
%plot(REF_sed_pO2_exp1(:,1),REF_sed_pO2_exp1(:,3),'k',REF_sed_pO2_exp2(:,1),REF_sed_pO2_exp2(:,3),'r',REF_sed_pO2_exp3(:,1),REF_sed_pO2_exp3(:,3),'r--',REF_sed_pO2_exp4(:,1),REF_sed_pO2_exp4(:,3),'g--'); 
%xlabel('years ');
...
if(plot_mean)  % mean (mol/kg)
    print(fig2, '-depsc', ['PLOTS/' FILENAME '_MEAN_2']);
else
    print(fig2, '-depsc', ['PLOTS/' FILENAME '_2']);
end
...
if(plot_mean)  % mean (mol/kg)
    print(fig3,'-depsc', ['PLOTS/' FILENAME '_MEAN_3']);
else
    print(fig3, '-depsc', ['PLOTS/' FILENAME '_3']);
end
