function [OUTPUT] = plot_fields_biogem_3d_k_raw(PEXP1,PEXP2,PVAR1,PVAR2,PT1,PT2,PIK,PMASK,PCSCALE,PCMIN,PCMAX,PCN,PDATA,POPT,PNAME)
% Dom: do not print title, colorbar or stamp
...
if ~exist('par_pathout','var'),  par_pathout  = 'PLOTS/k_levels'; end
...
%     end
    ...
    set(gca,'TickDir','out');
%     if ~isempty(plot_title)   % Dom comment
...
%     end
    ...
    % Dom: add text:
    formatSpec = '%.0f';
    txt1 = ['k-level: ' num2str(kplot, formatSpec)];
    txt2 = ['~ ' num2str(grid_zt(kplot), formatSpec) 'm'];
%    formatSpec = '%.1f';
%    txt = ['Mean: ' num2str(mean_noNaN, formatSpec) ' \mumol kg-1'];
   	text(-175,0.25,txt1,'FontSize',14);
   	text(-175,0.05,txt2,'FontSize',14);

%     if(kplot == 1)
%     	txt1 = ['Mean O_2 (\mumol kg-1)'];
%         text(-45,0.0,txt1,'FontSize',18);
%     end
