function [OUTPUT] = plot_fields_sedgem_2d_BE(PEXP1,PEXP2,PVAR1,PVAR2,PT1,PT2,PIK,PMASK,PCSCALE,PCMIN,PCMAX,PCN,PDATA,POPT,PNAME)
%
% DH: calculates the Burial Efficiency (in %) as (fburial_POC/fsed_POC)*100
% both fluxes are in mol cm-2 yr-1, so no adjustment needed
