function [OUTPUT] = plot_fields_sedgem_2d_BE_useBIOG(PEXP1,PEXP2,PVAR1,PVAR2,PT1,PT2,PIK,PMASK,PCSCALE,PCMIN,PCMAX,PCN,PDATA,POPT,PNAME)
%
% DH: calculates the Burial Efficiency (in %) as (fburial_POC/fsed_POC)*100
% here use POC settling flux from BIOGEM bc in sedgem this is equal to POC-burial
% BIOGEM flux isin mol m-2 yr-1 and SEDGEM in mol cm-2 yr-1, so adjustment needed!
...
% DH, Dom: Calculate BE
load('zm.mat');
data = (100^2*data_1./zm)*100;
% data = (data_1./data_2)*100;
